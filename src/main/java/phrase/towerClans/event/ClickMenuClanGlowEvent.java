...
public class ClickMenuClanGlowEvent extends Event implements Cancellable {
    ...
    public ClickMenuClanGlowEvent(ModifiedPlayer modifiedPlayer, InventoryClickEvent event) {
